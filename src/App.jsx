...
function App() {
  ...
  useEffect(() => {
    const apiUrl = `https://api.weatherapi.com/v1/current.json?key=9db5bfb695f94dba9dc194616241003&q=${city}&aqi=no;`;
  ...
  return (
    <div className="bg-[url('./assets/1.png')] h-screen flex justify-center  items-start">
